...
public class Remont extends AppCompatActivity {
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Remont.this, Sazlamalar.class));
               // Animatoo.animateSwipeLeft(Remont.this);
            }
        });
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(first.isEmpty()){
                    Alert alert=new Alert(Remont.this,"no",getResources().getString(R.string.attention),getResources().getString(R.string.warning1));
                    alert.ShowDialog();
                    return;
                }
                if(second.isEmpty()){
                    Alert alert=new Alert(Remont.this,"no",getResources().getString(R.string.attention),getResources().getString(R.string.error8));
                    alert.ShowDialog();
                    return;
                }
                ...
                RemontDB db=new RemontDB(Remont.this);
                boolean isInsert=db.insert(id,first,gun,String.valueOf(ay),yyl,km.getText().toString());
                if(isInsert) {
                    ...
                    CostsDB costsDB=new CostsDB(Remont.this);
                    boolean isLast=costsDB.insert(id,lastId,"3",gun,String.valueOf(ay),yyl,hepde);
                    if(isLast) {
                        CarDB db1 = new CarDB(Remont.this);
                        boolean isUpdate = db1.updateBenzin(id, km.getText().toString());
                        if (isUpdate) {
                            Toast.makeText(Remont.this, getResources().getString(R.string.succes), Toast.LENGTH_SHORT).show();
                    ...
                    Alert alert=new Alert(Remont.this,"no",getResources().getString(R.string.error_title2),getResources().getString(R.string.error_title3));
                    alert.ShowDialog();
                }
            }
        });
    ...
    public void onBackPressed() {
        finish();
        if(type.equals("1")) {
            Intent car = new Intent(Remont.this, Car_View.class);
            car.putExtra("id", id);
            startActivity(car);
        }
        if(type.equals("2")){
            Intent car = new Intent(Remont.this, My_Costs.class);
            car.putExtra("id", id);
            startActivity(car);
        }
    ...
    public void notif(){
        String CHANNEL_ID="1";
        CarDB carDB=new CarDB(Remont.this);
        CalyshmakDB calyshmakDB=new CalyshmakDB(Remont.this);
        ...
        while (cursor.moveToNext()) {
            ...
            if (cursor1.getCount() == 0) {
                ...
                while(cursor1.moveToNext()) {
                    ...
                    Intent snoozeIntent = new Intent(Remont.this, Calyshmak.class);
                    snoozeIntent.setAction("ACTION_SNOOZE");
                    snoozeIntent.putExtra("id", cursor.getString(0));
                    PendingIntent snoozePendingIntent =
                            PendingIntent.getActivity(Remont.this, 0, snoozeIntent, 0);


                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(Remont.this, cursor.getString(1)+"_"+cursor.getString(2));
...
//                                   snoozePendingIntent);
                    mNotificationManager =
                            (NotificationManager) Remont.this.getSystemService(Context.NOTIFICATION_SERVICE);
