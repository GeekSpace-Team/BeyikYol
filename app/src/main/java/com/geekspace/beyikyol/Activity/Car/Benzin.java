...
public class Benzin extends AppCompatActivity {
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Benzin.this, Sazlamalar.class));
               // Animatoo.animateSwipeLeft(Benzin.this);
            }
        });
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 if(first.isEmpty()){
                     Alert alert=new Alert(Benzin.this,"no",getResources().getString(R.string.attention),getResources().getString(R.string.litre_error));
                     alert.ShowDialog();
                     return;
                 }
                 if(second.isEmpty()){
                     Alert alert=new Alert(Benzin.this,"no",getResources().getString(R.string.attention),getResources().getString(R.string.error8));
                     alert.ShowDialog();
                     return;
                 }
                Calendar calendar = Calendar.getInstance();
                 ...
                 BenzinDB benzinDB=new BenzinDB(Benzin.this);
                 boolean isInsert=benzinDB.insertInto(id,first,second,gun,String.valueOf(ay),yyl);
                 ...
                 if(isInsert) {
                     ...
                     CostsDB costsDB=new CostsDB(Benzin.this);
                     boolean isLast=costsDB.insert(id,lastId,"1",gun,String.valueOf(ay),yyl,hepde);
                     if(isLast) {
                         CarDB db = new CarDB(Benzin.this);
                         boolean isUpdate = db.updateBenzin(id, second);
                         if (isUpdate) {
                             Toast.makeText(Benzin.this, getResources().getString(R.string.succes), Toast.LENGTH_SHORT).show();
                     ...
                     Alert alert=new Alert(Benzin.this,"no",getResources().getString(R.string.error_title2),getResources().getString(R.string.error_title3));
                     alert.ShowDialog();
                 }
            }
        });
    ...
    public void onBackPressed() {
        finish();
        if(type.equals("1")) {
            Intent car = new Intent(Benzin.this, Car_View.class);
            car.putExtra("id", id);
            startActivity(car);
        }
        if(type.equals("2")){
            Intent car = new Intent(Benzin.this, My_Costs.class);
            car.putExtra("id", id);
            startActivity(car);
        }
    ...
    public void notif(){
        String CHANNEL_ID="1";
        CarDB carDB=new CarDB(Benzin.this);
        CalyshmakDB calyshmakDB=new CalyshmakDB(Benzin.this);
        ...
        while (cursor.moveToNext()) {
            ...
            if (cursor1.getCount() == 0) {
                ...
                while(cursor1.moveToNext()) {
                    ...
                    Intent snoozeIntent = new Intent(Benzin.this, Calyshmak.class);
                    snoozeIntent.setAction("ACTION_SNOOZE");
                    snoozeIntent.putExtra("id", cursor.getString(0));
                    PendingIntent snoozePendingIntent =
                            PendingIntent.getActivity(Benzin.this, 0, snoozeIntent, 0);


                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(Benzin.this, cursor.getString(1)+"_"+cursor.getString(2));
...
//                                   snoozePendingIntent);
                    mNotificationManager =
                            (NotificationManager) Benzin.this.getSystemService(Context.NOTIFICATION_SERVICE);
