...
public class Custom_Spinner3 extends ArrayAdapter {
    Typeface trebu;
    public Custom_Spinner3(@NonNull Context context, ArrayList<Year> customlist) {
        super(context, 0, customlist);
        trebu=Typeface.createFromAsset(context.getAssets(), "fonts/trebuc.ttf");
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        if(convertView==null){
            convertView= LayoutInflater.from(getContext()).inflate(R.layout.lang_spinner,parent,false);
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if(convertView==null){
            convertView= LayoutInflater.from(getContext()).inflate(R.layout.custom_dp,parent,false);
